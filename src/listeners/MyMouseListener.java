...
public class MyMouseListener implements MouseListener{
    ...
    */
    ...
    public void mousePressed(MouseEvent e) {
        ...
        final JButton BUTTONS_FIND = Screen.getMy_BUTTONSpanel().getFINDbutton();
        final JButton BUTTONS_CLEAR = Screen.getMy_BUTTONSpanel().getCLEARbutton();
        ...
        else if(e.getSource()==BUTTONS_FIND){
            BUTTONS_FIND.setForeground(new Color(0,0,128));
        }
        else if(e.getSource()==BUTTONS_CLEAR){
            BUTTONS_CLEAR.setForeground(new Color(0,0,128));
        }
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        if(e.getSource()==BUTTONS_ADD){
            ...
            BUTTONS_FIND.setForeground(Color.BLUE);
        }
        else if(e.getSource()==BUTTONS_CLEAR){
            BUTTONS_CLEAR.setForeground(Color.BLUE);
        }
    ...
    public void mouseEntered(MouseEvent e) {
        ...
        if(e.getSource()==BUTTONS_ADD){
            ...
            BUTTONS_FIND.setForeground(Color.BLUE);
            BUTTONS_FIND.setFont(new Font("Arial",Font.PLAIN,20));
        }
        else if(e.getSource()==BUTTONS_CLEAR){
            BUTTONS_CLEAR.setForeground(Color.BLUE);
            BUTTONS_CLEAR.setFont(new Font("Arial",Font.PLAIN,20));
        }
    ...
    public void mouseExited(MouseEvent e) {
        ...
        if(e.getSource()==BUTTONS_ADD){
            ...
            BUTTONS_EDIT.setForeground(Color.WHITE);
            BUTTONS_EDIT.setFont(new Font("Arial",Font.PLAIN,16));
        }
        else if(e.getSource()==BUTTONS_REMOVE){
            ...
            BUTTONS_FIND.setForeground(Color.WHITE);
            BUTTONS_FIND.setFont(new Font("Arial",Font.PLAIN,16));
        }
        else if(e.getSource()==BUTTONS_CLEAR){
            BUTTONS_CLEAR.setForeground(Color.WHITE);
            BUTTONS_CLEAR.setFont(new Font("Arial",Font.PLAIN,16));
        }
