...
public class BUTTONSpanel {
    ...
    */
    ...
    public BUTTONSpanel(int WIDTH, int HEIGHT){
        ...
        //cria e edita botão PROCURAR
        FINDbutton = new JButton();
        ScreenFunctions.button_setup(FINDbutton, "Encontrar valor específico", 0, 6*button_height, WIDTH/5, button_height, Screen.myActionListener, panel);
        ScreenFunctions.button_edit(FINDbutton, new Font("Arial",Font.PLAIN,16), new Color(32,32,32), Color.WHITE);
        FINDbutton.setFocusable(false);
        FINDbutton.setBorder(null);
        FINDbutton.addMouseListener(Screen.myMouseListener);
        //remover preenchimento automático de fundo quando clicar
        ...
        //cria e edita botão LIMPAR
        CLEARbutton = new JButton();
        ScreenFunctions.button_setup(CLEARbutton, "Esvaziar tabela", 0, 7*button_height, WIDTH/5, button_height, Screen.myActionListener, panel);
        ScreenFunctions.button_edit(CLEARbutton, new Font("Arial",Font.PLAIN,16), new Color(32,32,32), Color.WHITE);
        CLEARbutton.setFocusable(false);
        CLEARbutton.setBorder(null);
        CLEARbutton.addMouseListener(Screen.myMouseListener);
        //remover preenchimento automático de fundo quando clicar
