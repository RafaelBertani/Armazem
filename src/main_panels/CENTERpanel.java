...
public class CENTERpanel {
    ...
    private FindPanel myFindPanel;
    private ClearPanel myClearPanel;
    ...
    public FindPanel getMyFindPanel() { return myFindPanel; }
    public ClearPanel getMyClearPanel() { return myClearPanel; }
    ...
    public CENTERpanel(int WIDTH, int HEIGHT){
        ...
        myFindPanel = new FindPanel(7*WIDTH/10, 6*HEIGHT/10);
        myClearPanel = new ClearPanel(7*WIDTH/10, 6*HEIGHT/10);
